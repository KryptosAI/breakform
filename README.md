...
# Convert STL to GLB
./target/release/eng convert corpus/cube-ascii.stl cube.glb

# Convert a STEP bracket to native EXL with fidelity report
./target/release/eng convert corpus/bracket.step out.exl --fidelity-report fidelity.json

# Validate the result
./target/release/eng validate --profile mech out.exl

# Inspect document structure
./target/release/eng info out.exl
```
