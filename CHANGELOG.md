...
### Fixed
- Release workflow: switch PyPI publish from deprecated `maturin upload` to `twine upload`
- Release workflow: make `build-binaries` job non-blocking (`continue-on-error`)
